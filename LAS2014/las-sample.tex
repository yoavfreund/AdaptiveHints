...
\title{L@S 2014 Work-in-Progress Format}
...
\begin{abstract}
Updated 8/7/2013.  In this sample paper, Sheridan Printing Co., Inc. describes the formatting requirements for SIGCHI Conference Proceedings, the format used for L@S 2014. This sample file offers recommendations on writing for a worldwide readership. Please review this document even if you have submitted to SIGCHI conferences before, some format details have changed relative to previous years.
Be sure to use the copyright box as it appears in the lower left hand corner of the first page. L@S 2014 Work-in-Progress papers must be no longer than 2 pages in length.
\end{abstract}
